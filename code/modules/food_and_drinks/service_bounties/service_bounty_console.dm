...
/obj/machinery/computer/bounty
	name = "Nanotrasen service bounty console"
	desc = "Used to check and claim bounties offered by local buisnesses and restaraunts."
	icon_screen = "bounty"
	circuit = /obj/item/circuitboard/computer/servicebounty
	light_color = "#6FD404"//Greenish
...
/obj/item/paper/bounty_printout
	name = "paper - Service Bounties"

/obj/item/paper/bounty_printout/Initialize()
	. = ..()
	info = "<h2>Nanotrasen Service Bounties</h2></br>"
...
/obj/machinery/computer/bounty/ui_interact(mob/user)
	...
	dat += "<p>Store Credit: <b>[SSservice.points]</b></p>"
	...
	var/datum/browser/popup = new(user, "service bounties", "Nanotrasen Service Bounties", 700, 600)
