...
/datum/controller/subsystem/ticker/proc/choose_lobby_music()
	...
	var/list/songs = list(
		...
		"https://www.youtube.com/watch?v=zo-x4PU8S6g",						// Weezer - Say it ain't so
		"https://www.youtube.com/watch?v=x4EpbuqJcRw",						// Thousand Foot Krutch - Phenomenon
		"https://www.youtube.com/watch?v=nLjVtDtyDlY"						// Foo Fighters - The Pretender
		)						
